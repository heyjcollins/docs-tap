...
>***Note:** each of the user-generated `namespace_provisioner.additional_sources.git.path` values in the example below must be unique and each value must begin with "_ytt_lib/" in order to be identified as a ytt libary. 
