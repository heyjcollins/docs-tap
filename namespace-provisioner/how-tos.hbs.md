...
>***Note:** Each of the user-generated `additional_sources.path` values in the example below must be unique and each value must begin with "_ytt_lib/" in order to be identified as a ytt libary. 
